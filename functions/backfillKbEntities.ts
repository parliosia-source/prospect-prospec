...
const SECTOR_SCORING_RULES = {
  ...
  "Technologie": {
    strongSignals: [
      "logiciel","software","saas","paas","iaas","cloud","cloud computing","nuage informatique",
      "informatique","it","tic","techno","technologie","tech",
      "intelligence artificielle","ia","ai","machine learning","apprentissage automatique","deep learning",
      "cybersecurite","securite informatique","securite de l information","soc","siem","pentest",
      "donnees","data","big data","analytique","analytics","base de donnees","entrepot de donnees","data lake",
      "developpement logiciel","developpement web","developpement mobile","application mobile","app mobile",
      "startup tech","startup","scale-up","incubateur tech","accelerateur tech",
      "erp","crm","mes","scada","progiciel","solution d affaires","solution entreprise",
      "devops","agile","scrum","integration continue","ci/cd",
      "api","microservice","architecture logicielle","plateforme numerique",
      "reseau","network","infrastructure it","serveur","hebergement","datacenter","centre de donnees",
      "robotique","automatisation","rpa","iot","internet des objets","systeme embarque",
      "realite virtuelle","realite augmentee","metavers","jeu video","gaming",
      "blockchain","web3","crypto","fintech tech",
    ],
    exclusions: [
      ...
      "cegep","ecole primaire","ecole secondaire","universite traditionelle",
    ],
  },
